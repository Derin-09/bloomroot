import { CheckCircleIcon, PhoneIcon, EnvelopeIcon, ClockIcon } from '@heroicons/react/24/outline';
// app/components/AboutSection.tsx
export default function AboutSection() {
  return (
    <section className="py-24 px-6 bg-primary-100 bg-neutral-300 text-dirtygreen">
      <div className="max-w-7xl mx-auto">
          ...
          <div className='flex items-center justify-center'>
            <ul className="mb-8 flex items-center mt-2 gap-2">
